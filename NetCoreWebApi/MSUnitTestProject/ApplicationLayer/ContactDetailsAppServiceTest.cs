...
namespace MSUnitTestProject.ApplicationLayer
{
    [TestClass]
    public class ContactDetailsAppServiceTest
    {
        ...
        public async Task Task_Get_Contact_List_Return_List()
        {
            ...
            // Assert
            Assert.IsInstanceOfType(result, typeof(IEnumerable<ContactDetail>));
        ...
        public async Task Task_Get_Contact_Details_By_Id_Return_Contact_Details()
        {
            ...
            // Assert
            Assert.IsInstanceOfType(result, typeof(ContactDetail));
